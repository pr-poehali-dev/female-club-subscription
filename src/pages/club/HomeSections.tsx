...
import { Section, HERO_IMG, MASTER_IMG, MEETINGS, MEMBERS, PLANS, NAV_ITEMS } from "./data";
...
export default function HomeSections({ active, navigate }: Props) {
  return (
    <>
      {/* ==================== HOME ==================== */}
      {active === "home" && (
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    style={{ border: "1px solid rgba(200,184,168,0.5)", backgroundColor: "transparent", color: "var(--graphite)" }}
                  />
                </div>
                <div>
